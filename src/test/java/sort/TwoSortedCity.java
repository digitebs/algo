 ...
 * the highest x and y.
 *
 * <p>double sort technique, top and bottom
 *
 * <p>then you sum from top and bottom
 *
 * <p>There are 2N people a company is planning to interview. The cost of flying the i-th person to
 * city A is costs[i][0], and the cost of flying the i-th person to city B is costs[i][1]. Return
