...
public class SmallestSubstring {
  ...
  */
  ...
  public static void main(String[] args) {
    //  System.out.println(new SmallestSubstring().getShortestUniqueSubstring(new
    // char[]{'x','y','z'},"xxzxxxkyzazyz"));
    System.out.println(
        new SmallestSubstring().getShortestUniqueSubstring(new char[] {'x', 'y', 'z'}, "zzxyzx"));
  }
}
