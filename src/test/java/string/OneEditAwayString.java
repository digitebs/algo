...
public class OneEditAwayString {
     ...
     *
     * one edit means add or delete or edit one character to match 2 string as [[Equals]]
     *
     * ==Example==
     * {{{
     *     "apple" vs "apkole" is false
     *     "e" vs "le" is true
     * }}}
     * @return
     */
   static public boolean OneEditAway(char[] s1, char[] s2){
       char[] b =s1,s =s2;
