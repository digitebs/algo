...
public class TimeAsciiRepresentation {
  ...
  char[][] timeASCIIRepresentation(char[][] dtime) {
    ...
    int hh = equalsAll(dtime, 1) * 10 + equalsAll(dtime, 5);
    int mm = equalsAll(dtime, 10) * 10 + equalsAll(dtime, 14);
  ...
  public static void main(String[] args) {
    //
    TimeAsciiRepresentation tar = new TimeAsciiRepresentation();
    tar.timeASCIIRepresentation(
        new char[][] {
          {'.', '*', '*', '*', '.', '.', '*', '.', '.', '.', '*', '*', '*', '.', '*', '*', '*'},
          {'.', '*', '.', '*', '.', '.', '*', '.', '.', '.', '.', '.', '*', '.', '*', '.', '*'},
          {'.', '*', '.', '*', '.', '.', '*', '.', '.', '.', '.', '.', '*', '.', '*', '.', '*'},
