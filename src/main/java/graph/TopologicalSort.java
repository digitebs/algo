...
public class TopologicalSort {
  ...
  void topologicalSortUtil(int v, HashMap<Integer, Boolean> visited, Stack stack) {
  ...
  void topologicalSort() {
    ...
    for (int i : adj.keySet()) if (visited.get(i) == false) topologicalSortUtil(i, visited, stack);
